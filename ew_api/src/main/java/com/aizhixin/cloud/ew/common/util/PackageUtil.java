...
//	// String packageName = "com.dinglicom.eye.mvc.v1.announcementList";
//	// List<String> classNames = getClassName(packageName, true);
//	// List<String> classNames = getClassNameByFile("G://eyeofwisdom_api",
////	 null, true);
//	// if (classNames != null) {
...
//	 String root = "G://eyeofwisdom_api";
//	 List<String> classNames = PackageUtil.getClassNameByFile(root,packageName,true);
...
//	 }
	...
	public static List<String> getClassNameByFile(String filePath, List<String> className, boolean childPackage) {
		...
		for (File childFile : childFiles) {
			...
			if (s.contains("src") && !s.contains("allapidetail")) {
				if (childFile.isDirectory()) {
					...
					if (s.contains("Controller") || s.contains("controller")) {
						if (childFilePath.endsWith(".java")) {
							childFilePath = childFilePath.substring(
									childFilePath.indexOf("\\classes") + childFilePath.indexOf("\\com") + 2,
