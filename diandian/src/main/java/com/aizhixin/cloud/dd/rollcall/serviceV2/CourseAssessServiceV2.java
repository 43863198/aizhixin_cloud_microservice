...
public class CourseAssessServiceV2 {
	...
	public TeacherPhoneCourseAssessDetailsDTOV2 findByTeachingClassId(Long teachingClassId) {
		...
		if(null!=teacherPhoneCourseAssessDetailsDTOV2){
			String data= teachingClassClient.getteachingclassInfo(teacherPhoneCourseAssessDetailsDTOV2.getTeachingClassId());
			...
			Integer stuTotal=0;
			stuTotal=	teachingClassClient.countStudents(teachingClassId);
