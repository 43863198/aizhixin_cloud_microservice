...
public class ElectricFenceQureyLeaveConnectPaginationSQL implements PaginationSQL {
	...
	public String getFindCountSql() {
		 String sql = " SELECT COUNT(1) FROM ( SELECT * FROM ("+ FIND_SQL  +") ss where 1 " ;
				 ...
				 if (collegeId != null) {
			       ...
			       if(starttime!=null){
			    	    sql += " and ss.noticeTime >= '"+ date+" "+starttime+"'"; 
			       }
			       if(endtime!=null){
			    	    sql += " and ss.noticeTime <= '"+ date.toString()+" "+endtime+"'"; 
			       }
			       if(dateTime!=null){
	...
	public String getFindSql() {
		String sql =  " select * from ( "+ FIND_SQL  +") ss where 1 " ;
		 ...
		 if (collegeId != null) {
	       ...
	       if(dateTime!=null){
//		    	   sql+=" AND TO_DAYS(NOW()) - TO_DAYS(noticeTime) <= 7";
	    	   sql += " AND DATE_FORMAT(noticeTime, '%Y-%m-%d') = '"+ dateTime+"'"; 
	       }
		return sql;
	}
	...
	public ElectricFenceQureyLeaveConnectPaginationSQL(Long skTeacherId,
	...
	public ElectricFenceQureyLeaveConnectPaginationSQL(Long skTeacherId, Long collegeId, Long majorId, Long classId,String dateTime, Long organId) {
		super();
		this.skTeacherId = skTeacherId;
		this.collegeId = collegeId;
		this.majorId = majorId;
