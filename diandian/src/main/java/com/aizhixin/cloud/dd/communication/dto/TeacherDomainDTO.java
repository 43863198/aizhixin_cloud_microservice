...
public class TeacherDomainDTO {
	...
	public TeacherDomainDTO() {}

	public TeacherDomainDTO(Long id, String name , String phone, String email, String jobNumber, String sex) {
		this.id = id;
		this.name = name;
		this.phone = phone;
		this.email = email;
	...
	public TeacherDomainDTO(Long id, String name , String phone, String email, String jobNumber, String sex, Long collegeId, String collegeName) {
