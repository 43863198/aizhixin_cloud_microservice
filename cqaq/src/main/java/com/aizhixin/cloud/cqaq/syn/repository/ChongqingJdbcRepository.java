package com.aizhixin.cloud.cqaq.syn.repository;
...
public class ChongqingJdbcRepository {
	...
	private static String SQL_TEACHER = "SELECT gh, XM, SSDW_ID FROM T_ZY_TeacherInfo WHERE (ltrim(rtrim(jszc)) in('0', '1','2') or jszc is null or jszc = '')";
