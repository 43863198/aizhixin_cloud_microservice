...
public class ProfessionalManager implements BaseDataManager {
	private final static String KEY = "ZYDM";// 数据库字段名称，专业编码
	private final static String NAME = "ZYMC";// 数据库字段名称，专业中文名称
	private final static String COLLEGE_KEY = "DWH";// 数据库字段名称，院系所编码
