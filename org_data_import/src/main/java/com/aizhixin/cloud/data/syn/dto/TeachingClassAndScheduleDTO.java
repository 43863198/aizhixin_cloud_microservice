...
public class TeachingClassAndScheduleDTO implements BaseDTO {
    ...
    @Getter @Setter private String classesCode;//班级编号
    @Getter @Setter private String className;//班级名称
    ...
    public String stringValue() {
        ...
        sb.append(courseCode).append("-").append(courseName).append(teacherCode).append("-").append(classesCode).append("-").append(className).append("-").append(dayOfWeek).append("-").append(classroom).append("-").append(week).append("-").append(dsz).append("-").append(period).append(rs);
        return sb.toString();
    }
