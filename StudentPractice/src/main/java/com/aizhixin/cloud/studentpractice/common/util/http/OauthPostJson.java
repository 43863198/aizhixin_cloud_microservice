...
public class OauthPostJson implements ResponseUtil {
    ...
    public HttpResponse post(String url, String params, String authResponseMap)
            throws IOException {
    ...
    public HttpResponse post2(String url, long userId, String params,
                              String authResponseMap) {
        HttpResponse httpResponse = null;
        try (CloseableHttpClient httpClient = HttpClients.createDefault()) {
            HttpPost post = new HttpPost(url);
