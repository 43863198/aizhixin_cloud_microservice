...
public class RollCallConstants {
	...
	public static final String ROLL_CALL_ASKFORLEAVE = "40025005";
	public static final String ROLL_CALL_ANTICHEATING = "40025006";
	public static final String ROLL_CALL_WARNING_TEACHERNOTOPEN_CODE = "40025007";
	public static final String ROLL_CALL_HAVING_CHANGE = "40025008";
	public static final String ROLL_CALL_CLOSE = "40025009";
