...
import com.aizhixin.cloud.rollcall.monitor.repository.DaybreakRepository;
import com.aizhixin.cloud.rollcall.monitor.utils.ApiReturn;
import com.aizhixin.cloud.rollcall.monitor.utils.StatusEnum;
import com.aizhixin.cloud.rollcall.service.RollcallDayTaskPreprocessService;
...
//    }
    ...
    public Map<String, Object> repairDayBreak(Long orgId, String orgName) {
        try {
            Set set = new HashSet();
            set.add(orgId);
            rollcallDayTaskPreprocessService.initRedisCurentDay(set);
        } catch (Exception e) {
