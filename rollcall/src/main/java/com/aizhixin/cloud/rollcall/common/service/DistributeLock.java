package com.aizhixin.cloud.rollcall.common.service;
...
public class DistributeLock {
     ...
     * @return  是否获取到锁
     */
    public boolean getInClassLock() {
        StringBuilder lockPath = new StringBuilder(zkLockPath);
        StringBuilder taskPath = new StringBuilder(zkTaskPath);
        Date current = new Date();
        String curDayString = DateUtil.format(current);
        String HHmm = DateUtil.format(current, "HHmm");
        lockPath.append("/").append(curDayString).append("/in/").append(HHmm);
        taskPath.append("/").append(curDayString).append("/in/").append(HHmm);
     ...
     * @return  是否获取到锁
     */
    public boolean getOutClassLock() {
        StringBuilder lockPath = new StringBuilder(zkLockPath);
        StringBuilder taskPath = new StringBuilder(zkTaskPath);
        Date current = new Date();
        String curDayString = DateUtil.format(current);
        String HHmm = DateUtil.format(current, "HHmm");
        lockPath.append("/").append(curDayString).append("/out/").append(HHmm);
        taskPath.append("/").append(curDayString).append("/out/").append(HHmm);
     ...
     * @return  是否获取到锁
     */
    public boolean getMedianLock() {
        StringBuilder lockPath = new StringBuilder(zkLockPath);
        StringBuilder taskPath = new StringBuilder(zkTaskPath);
        Date current = new Date();
        String curDayString = DateUtil.format(current);
        String HHmm = DateUtil.format(current, "HHmm");
        lockPath.append("/").append(curDayString).append("/median/").append(HHmm);
        taskPath.append("/").append(curDayString).append("/median/").append(HHmm);
