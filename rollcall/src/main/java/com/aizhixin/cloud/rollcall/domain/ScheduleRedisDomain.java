...
public class ScheduleRedisDomain implements java.io.Serializable {
    ...
    @Getter @Setter private String scheduleStartTime;
    @ApiModelProperty(value = "课堂结束时间")
    @Getter @Setter private String scheduleEndTime;
    @ApiModelProperty(value = "教室")
    @Getter @Setter private String classRoomName;
    @ApiModelProperty(value = "上课日期")
    @Getter @Setter private String teachDate;
    ...
    @Getter @Setter private Double toClassRate;
    ...
    @Getter @Setter private Long tempScheduleId;
}
