package com.aizhixin.cloud.rollcall.common.util;
...
/**
 * 类名称：GDMapUtil 类描述：TODO 创建人：MEIHUA.LI 创建时间：2016年11月28日 上午11:33:45 修改人：MEIHUA.LI 修改时间：2016年11月28日 上午11:33:45 修改备注：
 */
public class GDMapUtil {
    ...
    public String getMidDistribution() {
        return midDistribution.dimensionality + "-" + midDistribution.getLongitude();
    }
    ...
    public double compareMid(String location) {
        ...
        double l = Double.parseDouble(lstr[1]);
        double d = Double.parseDouble(lstr[0]);
        return midDistribution.getDistance(midDistribution, new Distribution(l, d));
    }
    ...
    public static double compare(String location, String midLocaltion) {
        ...
        Distribution midDistribution = new Distribution(Double.parseDouble(mstr[1]), Double.parseDouble(mstr[0]));
        return midDistribution.getDistance(midDistribution, new Distribution(Double.parseDouble(lstr[1]), Double.parseDouble(lstr[0])));
    }
