...
public class DianDianWeekSchoolTimeTableDomain {
    ...
    public DianDianWeekSchoolTimeTableDomain(Long teachingClassId, String teachingClassName, Long weekId, Long periodId, Integer periodNum, Integer dayOfWeek, String classroom) {
    ...
    public DianDianWeekSchoolTimeTableDomain(Long teachingClassId, String teachingClassName, String teachingClassCode, Long weekId, Long periodId, Integer periodNum,
        Integer dayOfWeek, String classroom) {
        this.teachingClassId = teachingClassId;
        this.teachingClassName = teachingClassName;
