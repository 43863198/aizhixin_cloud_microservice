...
@Data
@NoArgsConstructor
public class CorporateMentorsInfoPageByEnterpriseDTO {
    ...
    private PageData<StudentDTO> studentDTOList;

    public CorporateMentorsInfoPageByEnterpriseDTO(Long trainingGroupId, String trainingGroupName, Long teacherId, String teacherName){
