...
public class StudentDTO {
    ...
    public StudentDTO(Long id, Long accountId, String name, String jobNumber, String classesName, Long classesId, String professionalName, Long professionalId, String collegeName, Long collegeId,String phone,String email,String sex){
    	this.id = id;
    	this.accountId = accountId;
    	this.name = name;
    	this.jobNumber = jobNumber;
