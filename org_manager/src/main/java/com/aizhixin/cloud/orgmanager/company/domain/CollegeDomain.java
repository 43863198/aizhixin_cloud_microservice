...
public class CollegeDomain extends IdUserNameBase implements java.io.Serializable {
...
//	private Set<String> profesionalNames;
	...
	public CollegeDomain(College c) {
		this(c.getId(), c.getCode(), c.getName(), c.getOrgId(), c.getCreatedDate());
	}
}
