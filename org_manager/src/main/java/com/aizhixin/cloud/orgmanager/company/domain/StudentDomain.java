...
public class StudentDomain {
    ...
    public StudentDomain(Long id, String name, String phone, String email, String jobNumber, String sex, Long classesId, String classesName, Long professionalId,
        String professionalName, Long collegeId, String collegeName) {
    ...
    public StudentDomain(Long id, String name, String phone, String email, String jobNumber, String sex, Long classesId, String classesName, Long professionalId,
        String professionalName, Long collegeId, String collegeName, String teachingYear) {
        this(id, name, phone, email, jobNumber, sex, classesId, classesName);
        this.professionalId = professionalId;
        this.professionalName = professionalName;
        this.collegeId = collegeId;
    ...
    public StudentDomain(Long id, String name, String phone, String email, String jobNumber, String sex, Long classesId, String classesName, Long professionalId,
        String professionalName, Long collegeId, String collegeName, String teachingYear, Long orgId) {
        this(id, name, phone, email, jobNumber, sex, classesId, classesName);
        this.professionalId = professionalId;
        this.professionalName = professionalName;
        this.collegeId = collegeId;
...
//        this.studentSource = studentSource;
    ...
    public StudentDomain(Long id, String name, String phone, String jobNumber, String sex, Long professionalId, String professionalName, Long collegeId, String collegeName, Long orgId, String idNumber, String studentSource) {
        this(id, name, phone, null, jobNumber, sex, null, null, professionalId, professionalName, collegeId, collegeName, null, orgId);
        this.idNumber = idNumber;
        this.studentSource = studentSource;
    }
}
