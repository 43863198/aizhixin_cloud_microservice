...
@ApiModel(description="必修课课程表excel信息")
@NoArgsConstructor
@ToString
public class MustCourseScheduleExcelDomain implements Serializable {
    ...
    @ApiModelProperty(value = "classesExcelDomainList 教学班行政班列表", position=5)
    @Getter @Setter private List<ClassesExcelDomain> classesExcelDomainList;
