...
public class OauthGet implements ResponseUtil {
	...
	public HttpResponse get(String host, String url ,String authorization ) throws IOException {
    ...
    public HttpResponse get1(String url ,String param ,String authorization ) throws IOException {
   	 HttpResponse response = null;
        try(CloseableHttpClient httpClient = HttpClients.createDefault()) {
            //用get方法发送http请求
