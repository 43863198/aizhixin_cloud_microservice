package com.aizhixin.test.thread;
...
public class BioThreadPool {
     ...
     * 最优配置
     */
    public BioThreadPool() {
        int keepAliveTime = 10;
        int cpu = Runtime.getRuntime().availableProcessors() * 8;
        int maxinumPoolSize = cpu * 4;
        int capacity = 2000;
        this.queueSize = capacity;
        executor = new ThreadPoolExecutor(cpu, maxinumPoolSize, keepAliveTime, TimeUnit.SECONDS, new ArrayBlockingQueue<>(capacity));
    }
