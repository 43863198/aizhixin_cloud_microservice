...
public class ChongqingJdbcRepository {
	...
	private static String SQL_FDYINFO = "SELECT t.BJDM, z.gh, z.XM FROM t_xj_classinfo t LEFT JOIN t_zy_teacherinfo z ON t.fdyname = z.DM WHERE NJ in ('2016', '2017', '2018') and  gh is not null or xm is not null";
